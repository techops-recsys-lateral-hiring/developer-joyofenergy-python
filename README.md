...
When successful it will also containerize the application using the Dockerfile.  
...
The application will automatically generate a documentations and provide it under:
